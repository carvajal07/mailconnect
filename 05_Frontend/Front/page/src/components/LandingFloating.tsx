...
// Logo OFICIAL de WhatsApp (mismo trazado que WhatsAppGlyph de LandingPage.tsx). Este
// componente es aparte y no lo reusa a propósito: LandingFloating es autocontenido para
// poder montarse fuera de la landing sin depender de sus imports.
