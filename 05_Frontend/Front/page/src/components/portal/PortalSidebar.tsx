...
export const PORTAL_TABS: PortalTab[] = [
  ...
  { id: 'pdf', label: 'Plantillas PDF básicas', icon: <PictureAsPdfIcon /> },
  { id: 'estudio', label: 'Plantillas PDF avanzadas', icon: <DesignServicesIcon /> },
  { id: 'disenador', label: 'Plantillas PDF profesionales', icon: <ArchitectureIcon /> },
