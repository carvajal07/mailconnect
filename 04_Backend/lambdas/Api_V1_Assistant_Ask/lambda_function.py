...
SYSTEM_PROMPT = (
    ...
    "- \"Entrega garantizada\" (cascada): si el destinatario no responde/confirma por un "
    "canal, el sistema escala automáticamente al siguiente (correo → SMS) hasta lograr la "
    "entrega o agotar los canales configurados en la campaña.\n"
    "- IMPORTANTE — canales disponibles HOY: correo y SMS. WhatsApp y voz están en el "
    "plan de producto pero NO están disponibles todavía: si preguntan por ellos, dilo con "
    "claridad (\"por ahora ofrecemos correo y SMS; WhatsApp y voz vienen en camino\") y "
    "NUNCA los ofrezcas como algo que ya se puede contratar o usar.\n\n"
