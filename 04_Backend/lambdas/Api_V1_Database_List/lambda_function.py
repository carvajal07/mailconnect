...
# La consulta por customerId es SIEMPRE Query por el índice → escalable por defecto. Si el
# índice no existe, FALLA (no cae a Scan). (El fallback por NOMBRE de empresa de abajo es
# otra cosa: robustez ante desalineación del customerId, no una degradación del GSI.)
